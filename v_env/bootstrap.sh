...
cd /home/vagrant
openssl genrsa -out 172.31.20.2.key 2048
openssl req -new -x509 -key 172.31.20.2.key -out 172.31.20.2.cert -days 3650 -subj /CN=172.31.20.2
...
sudo -u www-data echo -e "Host 172.31.20.2\n\tStrictHostKeyChecking no\n" >> /home/www-data/.ssh/config

sudo -u www-data -H git clone admin@172.31.20.2:/home/admin/admin.git
